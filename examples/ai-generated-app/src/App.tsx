    ...
    <ThemeProvider defaultTheme="aurora">
      <div style={{ maxWidth: "880px", margin: "2rem auto", padding: "1rem" }}>
        <header style={{ marginBottom: "2rem" }}>
          <Badge variant="default" id="ai-status-badge">
            AI Agent Recipe Composed
          </Badge>
          ...
          <p style={{ color: "var(--ui-muted-foreground)" }}>
            Constructed deterministically via SoraUI MCP Server
          </p>
        </header>
        ...
        <div style={{ maxWidth: "420px", margin: "0 auto" }}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter your credentials to manage deployment clusters.
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              {submitted && (
                <div
                  ...
                  style={{
                    marginTop: "1rem",
                    padding: "0.75rem",
                    backgroundColor: "var(--ui-primary-subtle, #ecfdf5)",
                    borderRadius: "6px",
                  }}
                >
