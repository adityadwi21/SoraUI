  ...
  return (
    <ThemeProvider defaultTheme={theme}>
      <div style={{ maxWidth: "720px", margin: "2rem auto", padding: "1rem" }}>
        ...
        >
          <div>
            <h1 id="app-title" style={{ margin: 0 }}>
              SoraUI Vite SPA
            </h1>
        ...
        <Card style={{ marginBottom: "2rem" }}>
          ...
          <CardContent>
            ...
            <Tabs defaultValue="overview" style={{ marginBottom: "1.5rem" }}>
              <TabsList>
                <TabsTrigger value="overview" id="tab-trigger-overview">
                  Overview
                </TabsTrigger>
                <TabsTrigger value="settings" id="tab-trigger-settings">
                  Settings
                </TabsTrigger>
              </TabsList>
              <TabsContent value="overview" id="tab-content-overview">
                <p>
                  Welcome to the overview panel rendered by pure client SPA.
                </p>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button id="tooltip-btn" variant="secondary">
                      Hover Me
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent id="tooltip-content">
                    Accessible tooltip verified
                  </TooltipContent>
                </Tooltip>
              </TabsContent>
