        ...
        >
          <div>
            ...
            <p style={{ color: "var(--ui-muted-foreground)" }}>
              Hardened Release Candidate Verification
            </p>
          </div>
          <Button
            id="theme-toggle-btn"
        ...
        <Card style={{ marginBottom: "2rem" }}>
          <CardHeader>
            ...
            >
              ...
              <Badge variant="success" id="system-badge">
                Operational
              </Badge>
            </div>

            <CardDescription>
              Verified with zero hydration mismatch and zero monorepo leakage.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Input
            ...
            <Dialog>
              ...
              <DialogContent id="modal-content">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    This modal verifies focus trap, portal rendering, and escape
                    dismiss.
                  </DialogDescription>
                </DialogHeader>
