      ...
      <section className="showcase-container">
        ...
        <Card elevated>
          <CardHeader>
            ...
            <CardDescription>
              Visual state variations with focus rings and hover transitions
            </CardDescription>
          </CardHeader>
        ...
        <div className="showcase-grid-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Level 1 & Level 2 accessible form fields
              </CardDescription>
            </CardHeader>
            <CardContent className="form-stack">
              <div>
                ...
                <Input
                  ...
                  defaultValue="SoraUI Theme Project"
                />
              </div>
              <div>
              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      This dialog is rendered inside an accessible portal with
                      focus trap and backdrop blur.
                    </DialogDescription>
                  </DialogHeader>
                  <p style={{ margin: "1rem 0", fontSize: "0.875rem" }}>
                    All colors and radii adapt dynamically to your customized
                    CSS variables!
                  </p>
                  <DialogFooter>
                    <DialogClose asChild>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Level 3 zero-dependency date components
              </CardDescription>
            </CardHeader>
        ...
        <Card elevated>
          <CardHeader>
            ...
            <CardDescription>
              Sorting, search filtering, and paginated records
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div style={{ marginBottom: "1.5rem" }}>
              <Tabs defaultValue="members">
                ...
                <TabsContent value="analytics">
                  <div style={{ padding: "0.5rem 0" }}>
                    Monthly active users: <strong>14,250</strong> (+18.4% this
                    week).
                  </div>
                </TabsContent>
              </Tabs>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Drag and drop upload zone with client-side file queue
            </CardDescription>
          </CardHeader>
          <CardContent>
            <FileUploader
