    ...
    <div className="docs-page sora-shadcn-page">
      <div className="sora-doc-header">
        ...
        <p className="sora-doc-lead">
          Step-by-step instructions for migrating your codebase from Radix UI,
          shadcn/ui, or raw CSS to SoraUI.
        </p>
      ...
      <section className="sora-doc-section">
        <h2 id="shadcn-migration" className="sora-doc-h2">
          ...
          <a href="#shadcn-migration" className="sora-doc-anchor">
            #
          </a>
        </h2>
        <p className="sora-subtext">
          SoraUI follows the exact same component composition patterns and prop
          ergonomics as shadcn/ui, but eliminates runtime Tailwind dependencies
          in favor of pure CSS custom properties.
        </p>
        <div
          style={{
            padding: "1rem",
        ...
        >
          <p style={{ margin: 0, fontSize: "0.875rem", lineHeight: 1.7 }}>
            <strong>1. Component imports:</strong> Change{" "}
            <code>@/components/ui/button</code> to <code>@soraui/react</code> or
            use <code>npx @soraui/cli add button</code> to copy component source
          ...
          >
            <strong>2. CSS Variables:</strong> Replace Tailwind HSL variables
            with standard hex tokens from <code>@soraui/core</code> presets.
          </p>
        </div>
      </section>
      ...
      <section className="sora-doc-section">
        <h2 id="radix-migration" className="sora-doc-h2">
          ...
          <a href="#radix-migration" className="sora-doc-anchor">
            #
          </a>
        </h2>
        <p className="sora-subtext">
          SoraUI includes all accessible ARIA contracts natively without
          requiring multiple <code>@radix-ui/react-*</code> packages:
        </p>
        <CodeBlock
          language="tsx"
