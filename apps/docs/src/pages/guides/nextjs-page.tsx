...
export const NextjsPage: React.FC<NextjsPageProps> = ({ onNavigate }) => {
  ...
  const getCmd = (type: 'init-t' | 'add' | 'create-next' | 'init', tab: 'pnpm' | 'npm' | 'yarn' | 'bun', extra = '') => {
    if (type === 'init-t') {
      switch (tab) {
        case 'pnpm': return `pnpm dlx @soraui/cli@latest init -t next ${extra}`.trim();
        case 'npm': return `npx @soraui/cli@latest init -t next ${extra}`.trim();
        case 'yarn': return `yarn dlx @soraui/cli@latest init -t next ${extra}`.trim();
        case 'bun': return `bunx --bun @soraui/cli@latest init -t next ${extra}`.trim();
      }
    }
    if (type === 'add') {
      switch (tab) {
    ...
    if (type === 'create-next') {
      switch (tab) {
        case 'pnpm': return 'pnpm create next-app@latest my-app --typescript --eslint --app';
        case 'npm': return 'npx create-next-app@latest my-app --typescript --eslint --app';
        case 'yarn': return 'yarn create next-app my-app --typescript --eslint --app';
        case 'bun': return 'bun create next-app my-app --typescript --eslint --app';
      }
    }
    if (type === 'init') {
      switch (tab) {
        ...
        <div className="docs-step-flow">
          ...
          <div className="docs-step-flow-item">
            ...
            <div className="docs-step-flow-body">
              ...
              <p className="docs-step-flow-desc">
                Run the command generated by Theme Builder to create your project and configure all dependencies:
              </p>
        ...
        <div className="docs-step-flow">
          ...
          <div className="docs-step-flow-item">
            ...
            <div className="docs-step-flow-body">
              <h3 className="docs-step-flow-title">Create Project</h3>
              <p className="docs-step-flow-desc">
                Run the following command to initialize a new Next.js project with SoraUI:
              </p>
              <div className="docs-tabbed-codeblock">
                <div className="docs-tabbed-codeblock-header">
                  <div className="docs-tabbed-codeblock-tabs">
        ...
        <div className="docs-step-flow">
          ...
          <div className="docs-step-flow-item">
            ...
            <div className="docs-step-flow-body">
              <h3 className="docs-step-flow-title">Create Project</h3>
              <p className="docs-step-flow-desc">
                If you don't have an existing Next.js project, you can create one with <code>create-next-app</code>:
              </p>
              <div className="docs-tabbed-codeblock">
                <div className="docs-tabbed-codeblock-header">
                  <div className="docs-tabbed-codeblock-tabs">
                  ...
                  <button
                    type="button"
                    className="docs-tabbed-codeblock-copy"
                    onClick={() => copyText(getCmd('create-next', tab5), 'cmd5')}
                  >
          ...
          <div className="docs-step-flow-item">
            <div className="docs-step-flow-badge">2</div>
            <div className="docs-step-flow-body">
              <h3 className="docs-step-flow-title">Configure tsconfig.json Paths</h3>
              <p className="docs-step-flow-desc">
                Ensure your <code>tsconfig.json</code> contains baseUrl and paths mapping:
              </p>
              <CodeBlock
                language="json"
      ...
      "@/*": ["./*"]
          ...
          <div className="docs-step-flow-item">
            ...
            <div className="docs-step-flow-body">
              ...
              <p className="docs-step-flow-desc">
                Run the <code>@soraui/cli</code> init command to configure your existing project:
              </p>
              <div className="docs-tabbed-codeblock">
                <div className="docs-tabbed-codeblock-header">
                  <div className="docs-tabbed-codeblock-tabs">
              ...
              <div className="docs-tabbed-codeblock">
                <div className="docs-tabbed-codeblock-header">
                  ...
                  <button
                    type="button"
                    className="docs-tabbed-codeblock-copy"
                    onClick={() => copyText(getCmd('add', tab5, 'button'), 'cmd7')}
                  >
                    {copiedCmd === 'cmd7' ? <Check size={13} style={{ color: '#22c55e' }} /> : <Copy size={13} />}
                  </button>
                </div>
                <pre className="docs-tabbed-codeblock-pre">
