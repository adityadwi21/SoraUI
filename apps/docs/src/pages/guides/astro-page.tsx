...
export const AstroPage: React.FC<AstroPageProps> = ({ onNavigate }) => {
  ...
  const getCmd = (
    ...
    if (type === "init-t") {
      switch (tab) {
        case "pnpm":
          return `pnpm dlx @soraui/cli@latest init -t astro ${extra}`.trim();
        case "npm":
          return `npx @soraui/cli@latest init -t astro ${extra}`.trim();
        case "yarn":
          return `yarn dlx @soraui/cli@latest init -t astro ${extra}`.trim();
        case "bun":
          return `bunx --bun @soraui/cli@latest init -t astro ${extra}`.trim();
      }
    }
    if (type === "add") {
      switch (tab) {
    ...
    <article className="docs-page sora-intro-manifesto">
      ...
      <header className="docs-intro-header">
        ...
        <p className="docs-intro-lead">
          Install and configure Astro with React Island architecture and SoraUI
          components.
        </p>
      </header>
      ...
      <section className="docs-intro-section" id="use-theme-builder">
        ...
        <p>Configure and preview your cosmic theme preset for Astro:</p>
      ...
      <section className="docs-intro-section" id="use-the-cli">
        ...
        <p>Scaffold a new Astro project preconfigured with React and SoraUI:</p>
      ...
      <section className="docs-intro-section" id="existing-project">
        ...
        <CodeBlock language="bash" code="npx astro add react" />
        ...
        <h3 className="docs-intro-h3" style={{ marginTop: "1.5rem" }}>
          3. Import Tokens in Base Layout
        </h3>
        <CodeBlock
          language="astro"
...
<html lang="en">
  ...
  <body>
    <slot />
        ...
        <h3 className="docs-intro-h3" style={{ marginTop: "1.5rem" }}>
          4. Use React Islands with Directives
        </h3>
        <p>
          Use interactive components with <code>client:load</code> or{" "}
