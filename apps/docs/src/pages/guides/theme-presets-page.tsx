  ...
  const themes = [
    {
      ...
      bg: "#ffffff",
      darkBg: "#09090b",
      desc: "Modern cyan blue palette (default)",
    },
    {
      name: "Cloud",
      id: "cloud",
      ...
      bg: "#ffffff",
      darkBg: "#0f172a",
      desc: "Neutral slate gray minimal palette",
    },
    {
      name: "Aurora",
      id: "aurora",
      ...
      bg: "#ffffff",
      darkBg: "#064e3b",
      desc: "Vibrant emerald green nature palette",
    },
    {
      name: "Horizon",
      id: "horizon",
      ...
      bg: "#ffffff",
      darkBg: "#431407",
      desc: "Warm sunset orange energetic palette",
    },
    {
      name: "Twilight",
      id: "twilight",
      ...
      bg: "#ffffff",
      darkBg: "#2e1065",
      desc: "Deep violet dreamscape palette",
    },
    {
      name: "Midnight",
      id: "midnight",
      ...
      bg: "#09090b",
      darkBg: "#030712",
      desc: "True dark mode high contrast palette",
    },
    {
      name: "Nebula",
      id: "nebula",
      ...
      bg: "#ffffff",
      darkBg: "#500724",
      desc: "Cosmic pink futuristic palette",
    },
    {
      name: "Eclipse",
      id: "eclipse",
      ...
      bg: "#ffffff",
      darkBg: "#422006",
      desc: "Solar gold luminous palette",
    },
    {
      name: "Starlight",
      id: "starlight",
      ...
      bg: "#ffffff",
      darkBg: "#083344",
      desc: "Crisp teal aquatic palette",
    },
  ];
    ...
    <div className="docs-page sora-shadcn-page">
      <div className="sora-doc-header">
        ...
        <p className="sora-doc-lead">
          SoraUI includes 9 pre-engineered, accessible color palettes ready for
          instant use via CSS custom properties.
        </p>
