    ...
    <article className="docs-page sora-intro-manifesto">
      ...
      <div className="docs-install-banner">
        <div className="docs-install-banner-content">
          <strong>Recommended for new projects:</strong> Use <code>@soraui/cli</code> to initialize your project with preconfigured tokens and components.
        </div>
      </div>

      {/* ─── 3 SETUP CARDS ─── */}
      <div className="docs-intro-statement" style={{ margin: '1.75rem 0 1rem' }}>
      ...
      <section className="docs-intro-section" id="use-the-cli">
        ...
        <p className="docs-intro-note">
          For Laravel, create the app first with <code>laravel new</code>, then run <code>npx @soraui/cli@latest init</code>.
        </p>
      </section>
      ...
      <section className="docs-intro-section" id="existing-project">
        ...
        <p>
          Each framework guide includes an <strong>Existing Project</strong> section with the manual setup steps for that framework.
        </p>
        <p>
      ...
      <section className="docs-intro-section" id="choose-your-framework">
        <h2 className="docs-intro-h2">
          ...
          <a href="#choose-your-framework" className="docs-intro-anchor" aria-hidden>#</a>
        </h2>

        <p className="docs-intro-note">
          For Laravel, start with <code>laravel new</code> before using SoraUI CLI.
        </p>
              ...
              icon: (
                <svg viewBox="0 0 180 180" width="32" height="32" fill="currentColor">
                  ...
                  <g mask="url(#mask0)">
                    ...
                    <path d="M149.508 157.438L69.1478 54H54V125.97H66.1136V69.3836L139.999 164.845C143.333 162.614 146.509 160.137 149.508 157.438Z" fill="var(--docs-bg)"/>
                    <rect fill="var(--docs-bg)" height="72" width="12" x="115" y="54"/>
                  </g>
                </svg>
              ),
            },
            {
              ...
              icon: (
                <svg viewBox="0 0 32 32" width="32" height="32" fill="none">
                  <path d="M29.6 4.8L16.8 28.5c-.3.6-1.2.6-1.5 0L2.4 4.8c-.4-.7.1-1.6 1-.1.6L16 6.5l12.6-1.8c.8-.1 1.4.7 1 1.4z" fill="#bd34fe"/>
                  <path d="M22.5 2.5L16 15 9.5 2.5l6.5 1.5 6.5-1.5z" fill="#ffc837"/>
                </svg>
              ),
            },
            {
