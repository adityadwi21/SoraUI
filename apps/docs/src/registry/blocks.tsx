...
export const BLOCK_DOCS: BlockDoc[] = [
  {
    ...
    category: "auth",
    description:
      "Accessible login card with validation feedback, remember me checkbox, and OAuth slots.",
    ...
    props: [
      {
        ...
        description: "Header card title",
      },
      {
        name: "description",
        type: "string",
        default: "'Enter your credentials...'",
        description: "Header card subtitle",
      },
      {
      ...
      },
      {
        ...
        type: "boolean",
        default: "false",
        description: "Submitting loading state",
      },
      {
        name: "error",
        type: "string",
        description: "Server validation error message",
      },
      {
        name: "onSubmit",
        type: "(data: { email, password, rememberMe }) => void",
        description: "Form submission callback",
      },
      {
        name: "onSocialLogin",
        type: "(providerId: string) => void",
        description: "OAuth button click callback",
      },
    ],
    boundaryExplanation: {
      soraHandles: [
        "Form layout & card styling",
        "Local validation error banner",
        "Password field formatting",
        "Loading state spinner on button",
        "Keyboard submit & focus navigation",
      ],
      consumerHandles: [
        "Authentication API endpoint calls",
        "Session & token management",
        "OAuth redirect / SDK triggers",
        "Post-login routing",
      ],
    },
    code: `<LoginForm
...
/>`,
  ...
  },
  {
    ...
    category: "auth",
    description:
      "Sign-up card with real-time password strength meter and terms acceptance checkbox.",
    dependencies: [
      "card",
      "input",
      "label",
    ...
    props: [
      ...
      {
        name: "onSubmit",
        type: "(data: { name, email, password }) => void",
        description: "Registration callback",
      },
    ],
    boundaryExplanation: {
      soraHandles: [
        "Full layout and inputs",
        "Live password strength indicator",
        "Terms checkbox enforcement UI",
        "Focus management and a11y alerts",
      ],
      consumerHandles: [
...
/>`,
  ...
  },
  {
    ...
    category: "auth",
    description:
      "Password reset request card with success notification and back link.",
    ...
    props: [
      ...
      },
      {
        ...
        description: "Submission callback",
      },
    ],
    boundaryExplanation: {
      soraHandles: [
        "Email field validation UI",
        "Success banner switch",
        "Loading state",
        "Back-to-login navigation trigger",
      ],
      consumerHandles: [
        "Password reset email dispatcher API",
...
/>`,
  ...
  },
  {
    ...
    category: "auth",
    description:
      "Two-factor authentication PIN code entry card with auto-advance and resend action.",
    ...
    props: [
      {
        name: "recipient",
        type: "string",
        description: "Masked email or phone recipient",
      },
      {
        name: "length",
        type: "number",
      ...
      },
      {
        ...
        description: "Verification callback",
      },
      {
        name: "onResend",
        type: "() => void",
        description: "Resend code callback",
      },
    ],
    boundaryExplanation: {
      soraHandles: [
        "Slot-by-slot PIN auto-advance",
        "Clipboard paste distribution",
        "Button activation on complete entry",
      ],
      consumerHandles: [
        "2FA token verification API",
        "SMS/Email gateway triggers",
      ],
    },
...
/>`,
  ...
  },
  {
    ...
    category: "dashboard",
    description:
      "Responsive dashboard shell with collapsible sidebar, topbar, and user profile menu.",
    ...
    props: [
      ...
      },
      {
        ...
        description: "Navigation click",
      },
    ],
    boundaryExplanation: {
      soraHandles: [
        "Sidebar collapsing and tablet/mobile toggling",
        "Active route badge highlights",
        "User profile dropdown menu",
        "Consistent layout grid",
      ],
      consumerHandles: [
        "Client router transitions",
        "Permission checks & menu filtering",
...
>
  ...
  },
  {
    ...
    category: "dashboard",
    description:
      "Responsive KPI statistic grid with trend direction indicators and comparison periods.",
    ...
    boundaryExplanation: {
      soraHandles: [
        ...
        "Up/Down trend pills styling",
        "Card shadow and token colors",
      ],
      consumerHandles: [
        "Metric aggregation & telemetry fetching",
...
/>`,
  ...
  },
  {
    ...
    category: "dashboard",
    description:
      "Interactive data table shell with search filtering, selection, bulk actions, and pagination.",
    ...
    props: [
      {
        ...
        description: "Column headers and accessors",
        required: true,
      },
      {
        name: "data",
      ...
      },
      {
        name: "totalCount",
        type: "number",
        description: "Total records count for pagination",
      },
      {
        name: "onSearch",
      ...
      },
      {
        ...
        description: "Page navigation callback",
      },
    ],
    boundaryExplanation: {
      soraHandles: [
        "Search toolbar & input UI",
        "Row selection checkboxes",
        "Bulk action toolbar trigger",
        "Pagination controls",
      ],
      consumerHandles: [
...
/>`,
  ...
  },
  {
    ...
    category: "marketing",
    description:
      "High-impact token-driven marketing hero section with ambient glow and call-to-action buttons.",
    ...
    boundaryExplanation: {
      soraHandles: [
        "Radial token glow backdrop",
        "Typography scale clamp",
        "Dual CTA alignment",
        "Showcase container wrapping",
      ],
      consumerHandles: [
        "Product messaging copy",
        "Analytics CTA tracking",
        "Marketing funnel URLs",
      ],
    },
    code: `<HeroSection
...
/>`,
  ...
  },
  {
    ...
    category: "marketing",
    description:
      "Responsive multi-column feature showcase grid with icon badges.",
    ...
    boundaryExplanation: {
      soraHandles: [
        ...
        "Icon container styling with accent tokens",
        "Card elevating & hover transitions",
      ],
      consumerHandles: [
        "Feature descriptions & copywriting",
        "Custom iconography",
      ],
    },
    code: `<FeatureGrid
...
/>`,
        ...
        features={[
          {
            ...
            description: "Pure CSS variables mean 0ms stylesheet generation.",
          },
          {
            id: "2",
            title: "Full Keyboard A11y",
            description: "WAI-ARIA compliant with roving tabindex.",
          },
          {
            id: "3",
            title: "9 Space Themes",
            description: "Light, dark, and ambient space palettes.",
          },
        ]}
      />
    ),
  },
  {
    ...
    category: "marketing",
    description:
      "Tiered pricing table with monthly/annual switch toggle and feature checklists.",
    ...
    props: [
      ...
      {
        name: "onBillingIntervalChange",
        type: '(interval: "monthly" | "annual") => void',
        description: "Toggle callback",
      },
      {
        name: "onSelectPlan",
        type: "(plan: PricingPlan) => void",
        description: "Select plan action",
      },
    ],
    boundaryExplanation: {
      soraHandles: [
        "Billing interval switch UI",
        "Highlighting popular tiers with primary border",
        "Checkmark feature lists",
        "Responsive columns",
      ],
      consumerHandles: [
        "Stripe / payment checkout redirection",
        ...
        plans={[
          {
            ...
            name: "Starter",
            price: "$0",
            features: ["1 Project", "Community Discord"],
          },
          {
            id: "pro",
            name: "Pro",
          ...
          },
          {
            ...
            price: "$99",
            period: "mo",
            features: ["Dedicated SLA", "Custom Registry", "Audit Logs"],
          },
        ]}
      />
    ),
  },
  {
    ...
    boundaryExplanation: {
      soraHandles: [
        ...
        "Smooth transition collapse",
      ],
      consumerHandles: [
        "Product Q&A copywriting",
...
/>`,
    render: () => (
      <FAQSection
        items={[
          {
            id: "1",
            question: "Is SoraUI free for commercial use?",
            answer: "Yes! SoraUI is 100% open source under the MIT License.",
          },
          {
            id: "2",
            question: "Does SoraUI support Next.js App Router?",
            answer:
              "Yes! All components support React Server Components and SSR.",
          },
        ]}
      />
    ),
  },
  {
    ...
    category: "marketing",
    description:
      "Responsive page footer with brand identity, newsletter subscription, and link columns.",
    ...
    boundaryExplanation: {
      ...
      consumerHandles: [
        "Mailing list API subscription",
        "Privacy & Terms link routing",
      ],
    },
    code: `<FooterSection
  columns={[
...
/>`,
  ...
  },
  {
    ...
    category: "forms",
    description:
      "Multi-step form wizard with progress stepper and back/next navigation.",
    ...
    props: [
      {
        name: "steps",
        type: "WizardStep[]",
        description: "Array of form steps",
        required: true,
      },
      {
        name: "onComplete",
        type: "() => void",
        description: "Completion action",
      },
    ],
    boundaryExplanation: {
      soraHandles: [
        "Step number tracker header",
        "Next/Back step transition state",
        "Button disabled states",
      ],
      consumerHandles: [
        "Draft state preservation",
        "Step-by-step API validation",
        "Final checkout or account submission",
      ],
    },
...
/>`,
        ...
        steps={[
          {
            ...
            title: "Account",
            component: (
              <div style={{ padding: "1rem 0" }}>Step 1: Account Setup</div>
            ),
          },
          {
            id: "2",
          ...
          },
          {
            ...
            title: "Review",
            component: (
              <div style={{ padding: "1rem 0" }}>Step 3: Review & Confirm</div>
            ),
          },
        ]}
      />
  ...
  },
  {
    ...
    category: "forms",
    description:
      "Tabbed account settings form with switches, avatar upload, and security fields.",
    dependencies: [
      "card",
      "tabs",
      "input",
    ...
    props: [
      ...
      },
      {
        ...
        description: "Save changes action",
      },
    ],
    boundaryExplanation: {
      soraHandles: [
        "General/Notifications/Security tabs switching",
        "Form input layout & switches",
        "Success message confirmation",
      ],
      consumerHandles: [
        "Profile update mutation API",
        "Avatar image upload to CDN",
