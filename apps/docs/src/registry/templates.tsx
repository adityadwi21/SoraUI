...
export const TEMPLATE_DOCS: TemplateDoc[] = [
  {
    ...
    category: "auth",
    description:
      "Full split-screen authentication page layout with brand quote.",
    blocks: ["login-form"],
...
/>`,
  ...
  },
  {
    ...
    category: "dashboard",
    description:
      "Full dashboard page composing DashboardShell, MetricGrid, and DataTableBlock.",
...
/>`,
  ...
  },
  {
    ...
    category: "marketing",
    description:
      "Full marketing landing page composing HeroSection, FeatureGrid, PricingTable, FAQSection, and FooterSection.",
    blocks: [
      "hero-section",
      "feature-grid",
      "pricing-table",
    ...
    render: () => (
      ...
      >
        <SaaSLandingPageTemplate
          hero={{
            title: "Ship Faster with SoraUI",
            description:
              "Zero runtime styling, pure CSS tokens, full keyboard accessibility.",
          }}
          features={{
            ...
            features: [
              {
                id: "1",
                title: "Lightweight",
                description: "< 1.5 KB per primitive",
              },
              { id: "2", title: "Themable", description: "9 preset palettes" },
            ],
          }}
          pricing={{
            plans: [
            ...
            items: [
              {
                ...
                answer:
                  "Yes! SoraUI is 100% open source under the MIT license.",
              },
            ],
          }}
          footer={{
