...
export function Alert({ variant = "default", className = "", children, ...props }: any) {
  return (
    <div
      role="alert"
      className={\`sora-alert \${variant === "destructive" ? "sora-alert--destructive" : ""} \${className}\`.trim()}
      {...props}
    >
      {children}
    </div>
...
export function AlertTitle({ className = "", children, ...props }: any) {
  return (
    <h5 className={\`sora-alert__title \${className}\`.trim()} {...props}>
      {children}
    </h5>
  );
}
...
export function AlertDescription({ className = "", children, ...props }: any) {
  return (
    <div className={\`sora-alert__description \${className}\`.trim()} {...props}>
      {children}
    </div>
  );
}
...
export function AspectRatio({ ratio = 16 / 9, style, className = "", children, ...props }: any) {
  return (
    <div
      className={\`sora-aspect-ratio \${className}\`.trim()}
      style={{
...
export function Attachment({ layout = "list", className = "", children, ...props }: any) {
  return (
    <div className={\`sora-attachment sora-attachment--\${layout} \${className}\`.trim()} {...props}>
      {children}
    </div>
  );
}

export function AttachmentItem({ className = "", children, ...props }: any) {
  return (
    <div className={\`sora-attachment__item \${className}\`.trim()} {...props}>
      {children}
    </div>
  );
}

export function AttachmentIcon({ className = "", children, ...props }: any) {
  return (
    <div className={\`sora-attachment__icon \${className}\`.trim()} {...props}>
      {children || <FileText size={18} />}
    </div>
  );
}
...
export function AttachmentInfo({ className = "", children, ...props }: any) {
  return (
    <div className={\`sora-attachment__info \${className}\`.trim()} {...props}>
      {children}
    </div>
  );
}
...
export function AttachmentName({ className = "", children, ...props }: any) {
  return (
    <div className={\`sora-attachment__name \${className}\`.trim()} {...props}>
      {children}
    </div>
  );
}

export function AttachmentSize({ sizeInBytes, children, className = "", ...props }: any) {
  const formatted = sizeInBytes
    ? sizeInBytes >= 1048576
  ...
  return (
    <div className={\`sora-attachment__size \${className}\`.trim()} {...props}>
      {formatted}
    </div>
  );
}
...
export function AttachmentActions({ className = "", children, ...props }: any) {
  return (
    <div className={\`sora-attachment__actions \${className}\`.trim()} {...props}>
      {children}
    </div>
  );
}

export function AttachmentRemove({ onRemove, className = "", ...props }: any) {
  return (
    <button
      type="button"
      className={\`sora-attachment__remove \${className}\`.trim()}
      onClick={onRemove}
