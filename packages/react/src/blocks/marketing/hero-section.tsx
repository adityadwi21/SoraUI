    ...
    >
      ...
      <div
        ...
        style={{
          ...
          width: '600px',
          height: '400px',
          background: 'radial-gradient(ellipse at center, var(--ui-primary, #0ea5e9) 0%, transparent 70%)',
          opacity: 0.15,
          filter: 'blur(60px)',
          pointerEvents: 'none',
          zIndex: 0,
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: '800px' }}>
        {badge && (
          <div style={{ marginBottom: '1.5rem' }}>
            <Badge variant="secondary" style={{ padding: '0.375rem 0.875rem', fontSize: 'var(--sora-text-sm, 0.875rem)', cursor: badge.href ? 'pointer' : 'default' }}>
              {badge.text}
            </Badge>
          </div>
        )}
