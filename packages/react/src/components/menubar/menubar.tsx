...
export const Menubar = forwardRef<HTMLDivElement, MenubarProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      role="menubar"
      className={cx("sora-menubar", className)}
      {...props}
    />
  ),
);
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cx(
        "sora-menubar__trigger",
        ctx.open && "sora-menubar__trigger--open",
        className,
      )}
      {...props}
    />
...
export const MenubarItem = forwardRef<HTMLDivElement, MenubarItemProps>(
  ({ disabled, className, onClick, ...props }, ref) => {
    const ctx = useContext(MenuContext);
    ...
    return (
      <div
        ...
        className={cx(
          "sora-menubar__item",
          disabled && "sora-menubar__item--disabled",
          className,
        )}
        {...props}
      />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    role="separator"
    className={cx("sora-menubar__separator", className)}
    {...props}
  />
));
