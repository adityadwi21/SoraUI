...
export function Dialog({
  ...
  return (
    <DialogContext.Provider value={{ open, setOpen, titleId, descriptionId, triggerRef }}>
      {children}
    ...
    return (
      <Portal>
        <div className="sora-dialog__wrapper">
          <DialogOverlay onClick={closeOnOverlayClick ? () => setOpen(false) : undefined} />
          <div
            ref={mergedRef}
            role="dialog"
            aria-modal="true"
...
export const DialogTitle = forwardRef<HTMLHeadingElement, DialogTitleProps>(
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <h2 ref={ref} id={titleId} className={cx('sora-dialog__title', className)} {...props}>
        {children}
      </h2>
    );
  }
...
export const DialogDescription = forwardRef<HTMLParagraphElement, DialogDescriptionProps>(
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <p ref={ref} id={descriptionId} className={cx('sora-dialog__description', className)} {...props}>
        {children}
      </p>
    );
  }
