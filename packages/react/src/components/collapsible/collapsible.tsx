...
import type { CollapsibleProps, CollapsibleTriggerProps, CollapsibleContentProps } from './collapsible.types';
...
export const CollapsibleContent = forwardRef<HTMLDivElement, CollapsibleContentProps>(
  ({ className, ...props }, ref) => {
    ...
    return <div ref={ref} className={cx('sora-collapsible__content', className)} {...props} />;
  }
);
