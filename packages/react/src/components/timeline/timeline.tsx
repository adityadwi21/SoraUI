...
export const Timeline = forwardRef<HTMLOListElement, TimelineProps>(({ className, ...props }, ref) => (
...
export const TimelineItem = forwardRef<HTMLLIElement, TimelineItemProps>(
  ({ active = false, className, children, ...props }, ref) => (
    <li
      ref={ref}
      className={cx('sora-timeline__item', active && 'sora-timeline__item--active', className)}
      {...props}
    >
