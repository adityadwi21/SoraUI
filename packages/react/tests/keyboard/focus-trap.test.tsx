  ...
  it("only one tab has tabIndex=0 at a time", () => {
    render(
      <Tabs defaultValue="tab1">
        <TabsList>
          <TabsTrigger value="tab1" data-testid="t1">
            Tab 1
          </TabsTrigger>
          <TabsTrigger value="tab2" data-testid="t2">
            Tab 2
          </TabsTrigger>
          <TabsTrigger value="tab3" data-testid="t3">
            Tab 3
          </TabsTrigger>
        </TabsList>
...
describe("12C — RadioGroup Roving Tabindex", () => {
  it("only one radio has tabIndex=0 at a time", () => {
    ...
    const zeroCount = allRadios.filter(
      (r) =>
